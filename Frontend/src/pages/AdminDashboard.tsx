...
import { Users, Video, DollarSign, Activity, ArrowLeft } from 'lucide-react';
...
const AdminDashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Load mock data (in real app, fetch from backend)
    loadAdminData();
  }, [navigate]);
  ...
  const loadAdminData = () => {
    ...
    setTimeout(() => {
      ...
      setRecentUsers([
        ...
        { id: '2', name: 'Jane Smith', email: 'jane@example.com', role: 'USER', createdAt: '2024-01-14' },
        { id: '3', name: 'Bob Johnson', email: 'bob@example.com', role: 'USER', createdAt: '2024-01-13' },
        { id: '4', name: 'Alice Brown', email: 'alice@example.com', role: 'USER', createdAt: '2024-01-12' },
        { id: '5', name: 'Charlie Wilson', email: 'charlie@example.com', role: 'USER', createdAt: '2024-01-11' },
      ]);
      setLoading(false);
    }, 1000);
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition-shadow cursor-pointer">
            ...
            <p className="text-gray-600 text-sm">Monitor all projects and videos</p>
          </div>
